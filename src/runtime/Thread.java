...
public class Thread {
    ...
    public void run(final int starting_address,final int[] instructions) throws EmptyStackException {
        ...
        for (program_counter_resister = 0;
            ...
            switch (runtime_stack.peek() & 0xff) {
                ...
                case 0x02: // print get
                    ...
                    switch (values(0)) {
                        ...
                        case 0x1: // int[]
                            ...
                            break;
                        case 0x2: // char
                            System.out.println((char) values(1));
                            break;
                        case 0x3: // char[]
                            String char_array = "";
                            for (int i = values(1); i < values(1) + values(2); i++) {
                ...
                case 0x20: // put byte
                    ...
                    break;
                case 0x21: // put todo how to describe objects
